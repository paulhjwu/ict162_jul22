...
from Lab2_3_sem4 import Airline, BookingException

# class BookingException(Exception):
#     '''Booking Exception User Defined Class'''

# b. Modify the Airline class to cater for the new requirements:
#  searchBooking(bookingId) – Return the Booking object from the dictionary
# that matches the given parameter bookingId. Otherwise, this method
# returns None.
...
# i.e. 2 bookings with same booking id.
    ...
    airline1 = Airline('Singapore Air')
